    ...
    const roadmapItems = [
        {
            ...
            tasks: [
                ...
                { task: "Enable easy Feedback.", status: taskStatus.completed },
                { task: "Landing page", status: taskStatus.completed },
                { task: "Add progress bar when on-boarding", status: taskStatus.upcoming },
